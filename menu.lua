-- ══════════════════════════════════════════════════════
--           LULUCLC3 MENU v44.0 - ZENITH EDITION 👑
--      DESIGN DE LUXE | PROGRESS BAR | CRÉÉ PAR LULUCLC3
-- ══════════════════════════════════════════════════════
...
-- [1] INITIALISATION AVEC BARRE DE PROGRESSION (LUXE)
local LoaderGui = Instance.new("ScreenGui")
LoaderGui.Parent = game:GetService("CoreGui")
local LoadFrame = Instance.new("Frame")
LoadFrame.Size = UDim2.new(0, 300, 0, 50)
LoadFrame.Position = UDim2.new(0.5, -150, 0.8, 0)
...
Bar.BackgroundColor3 = Color3.fromRGB(255, 215, 0) -- Or
...
LoadText.Text = "Initialisation 0%"
...
for i = 0, 100, 10 do
    ...
    LoadText.Text = "Chargement " .. i .. "%"
    task.wait(0.1)
end
LoaderGui:Destroy()

-- [2] INTERFACE PRINCIPALE "ZENITH"
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "Luluclc3_Zenith"
...
local Settings = {
    speed = 100, jump = 150,
    esp = false, aura = false, auraRange = 50,
